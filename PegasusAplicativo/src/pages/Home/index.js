...
import { TextInput, Dimensions, Text, View, Button, Modal, TouchableOpacity, Image, FlatList, Pressable } from "react-native";
...
export default function Home() {
    ...
    const products = [
        { 
            id: '1', 
            name: "Tênis Air Max TN", 
            price: "R$ 799,90", 
            discount: "R$ 999,90", 
            image: require("../../../assets/airMaxTN.jpeg"),
            rating: 4.8,
            sold: 125,
            promo: "20% OFF"
        },
        { 
            ...
            price: "R$ 129,90", 
            discount: "R$ 159,90", 
            image: require("../../../assets/dryfit-shirt.jpg"),
            rating: 4.5,
            sold: 89,
            promo: "18% OFF"
        },
        { 
            id: '3', 
            name: "Short de Corrida", 
            price: "R$ 149,90", 
            discount: "", 
            image: require("../../../assets/running-shorts.jpg"),
            rating: 4.7,
            sold: 42
        },
        { 
            ...
            price: "R$ 39,90", 
            discount: "R$ 49,90", 
            image: require("../../../assets/sport-socks.jpg"),
            rating: 4.3,
            sold: 210,
            promo: "PROMO"
        },
        ...
        <View style={style.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={style.containerCarrouselImagens}>
                    <View style={style.carrouselImagens}>
                        {/* <FlatList
                            data={carouselImages}
                            horizontal
                            pagingEnabled
                            ...
                            onScroll={(event) => {
                                ...
                                setActiveCarouselIndex(Math.round(index));
                            }}
                        />
                        <View style={style.carouselDotContainer}>
                            {carouselImages.map((_, index) => (
                                <View 
                                    ...
                                    style={[
                                        style.carouselDot,
                                        index === activeCarouselIndex && style.carouselDotActive
                                    ]}
                                />
                            ))}
                        </View> */}
                        ...
                        <View style={style.dotsContainer}>
                            ...
                            <View
                                ...
                                style={[
                                style.dot,
                                index === activeCarouselIndex && style.activeDot,
                                ]}
                            />
                            ))}
                        </View>
                            ...
                            >
                                ...
                                <View style={style.productInfo}>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        ...
                                        {product.discount && (
                                            <Text style={style.productDiscount}>{product.discount}</Text>
                                        )}
                                    </View>
